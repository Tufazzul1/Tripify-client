...
const Footer = () => {
    return (
        <div className='p-10 bg-base-300 text-base-content mt-8'>
            <footer className="footer ">
                <nav>
                    <h6 className=" text-3xl text-[#2d0057] font-bold">Tripify</h6>
                ...
                <nav>
                    ...
                    <h4>Number : +13273748798</h4>
                    <h4> Email : tufajjul2017@gmail.com</h4>
            ...
            <div className=''>
                <p>Copyright © 2024 - All right reserved by <span className='font-bold'>Tripify</span></p>
            </div>
        </div>
    );
};
